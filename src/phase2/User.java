...
public class User 
{
	...
	*/
	public void InsertUser(String Name, String Login, int type, String Password, String Address, int PhoneNumber, Connector con) throws Exception
	{
		...
		try{
		      ...
		      preparedStmt.setInt(6, PhoneNumber);
